...
const DEMO_PROJECTS: Project[] = [
  {
    ...
    updatedAt: null,
    editing: { captions: true, hookTitle: true, chapterCards: true, endScreen: true, sfx: true, sfxLevel: 0.35, music: false, drawnCards: true, speed: 1, speedLocked: false, voice: null },
