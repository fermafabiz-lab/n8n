...
if (['classic', 'editorial', 'punch', 'lowerThird', 'kidsPill', 'kidsBounce', 'kidsSticker'].includes(opts.motionPack)) body.motionPack = opts.motionPack;
...
// (db/port/kids-cine-graphics/); every id the render knows is accepted here.
const STYLES = ['classic', 'reportage', 'editorial', 'cinematic', 'handwritten', 'kidsStorybook', 'kidsPlayful', 'kidsAll', 'cineFilm', 'cineNeon', 'cineMemory'];
