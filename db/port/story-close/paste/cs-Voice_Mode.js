...
`;
return [{ json: { mode, characters, noNarrator, cinematic, kids, castSize: cast.length, narrationRules: narrationRules + kidsNarration + closingNarration, segmentRules: segmentRules + kidsSegment + closingSegment, hookRules: hookRules + kidsHook, closing: { wanted: closingWanted, kids: closingWanted && kids }, closingOutline, closingOutlineLine, closingEditor, hookStyle: hookForced ? hookAllowed[0] : 'auto', hookStyleWanted: HOOK_STYLES.includes(hookStyleWanted) ? hookStyleWanted : 'auto', hookAllowed, hookForced, hookSilentStyles: SILENT_HOOK_STYLES, hookStyleRules, hookSegmentRules } }];