 ...
 * instead of an n8n webhook: voice takes (phase 2) and image regenerations
 * (phase 3) of docs/plans/engine-media-generation.md; clips follow.
 *
...
export async function stopVoiceTake(sceneId: string, kind: "voice" | "image" = "voice"): Promise<number> {
