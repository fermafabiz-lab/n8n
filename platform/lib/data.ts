...
const DEMO_PROJECTS: Project[] = [
  {
    ...
    updatedAt: null,
    editing: { captions: true, hookTitle: true, chapterCards: true, endScreen: true, sfx: true, sfxLevel: 0.35, music: false, musicTrack: null, musicLevel: 0.22, styleRefs: [], drawnCards: true, captionColor: null, videoModel: null, speed: 1, speedLocked: false, sourceWatermark: true, voice: null, autoApprove: false },
