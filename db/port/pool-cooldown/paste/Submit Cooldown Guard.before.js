...
console.log('Submit Video failed (' + n + '/' + MAX + '), cooling down 60s' + (attached ? ' WITHOUT the end frame' : '') + ': ' + last);
return [{ json: { cooldown: n, lastError: last, sceneId: key, dropEndFrame: attached } }];
